...
~~Нейрослоплю~~ э-э-э то есть промптъинженерю некоторые свои проекты для себя, так программированием теперь особо не занимаюсь .<br/>
...
<ul>
  <li><a href="https://github.com/Iwakawa-2173/tibetan-buddhism-gpt-2" target="_blank">Настольное Windows-приложение-чат с русскоязычной GPT-2, которая была мной дообучена на буддийских текстах. (RAG-модель - есть планы взять более новую модель и улучшить, а также надо дообучить на сериях "вопрос-ответ")</a></li>
  ...
  <li><a href="https://github.com/Iwakawa-2173/The-Wanderer" target="_blank">Игра про мегаструктуру, в которой НЕТ МОНСТРОВ И СКРИМЕРОВ!</a></li>
</ul>
